...
import { FileText, Database, BookOpen, Clock, CheckCircle, Activity, Download, Trash2, Plus } from 'lucide-react';
          ...
          <div key={doc.id} className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="bg-blue-500/20 hover:bg-blue-500/40 text-blue-400 p-3 rounded-xl transition-all duration-300 transform hover:scale-110">
